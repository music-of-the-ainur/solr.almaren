...
```
libraryDependencies += "com.github.music-of-the-ainur" %% "solr-almaren" % "0.3.2-3.1"
```
...
```
spark-shell --master "local[*]" --packages "com.github.music-of-the-ainur:almaren-framework_2.12:0.9.3-3.1,com.github.music-of-the-ainur:solr-almaren_2.12:0.3.2-3.1"
```
