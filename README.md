...
```
libraryDependencies += "com.github.music-of-the-ainur" %% "solr-almaren" % "0.3.5-3.2"
```

To run in spark-shell:

```
spark-shell --master "local[*]" --packages "com.github.music-of-the-ainur:almaren-framework_2.12:0.9.10-3.2,com.github.music-of-the-ainur:solr-almaren_2.12:0.3.5-3.2"
```
