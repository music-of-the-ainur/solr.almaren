...
private[ainur] class SourceSolr(collection: String,zkHost: String, options:Map[String,String]) extends Source with LazyLogging {
...
private[ainur]  class TargetSolr(collection: String,zkHost: String, saveMode:SaveMode, options:Map[String,String]) extends Target with LazyLogging {
